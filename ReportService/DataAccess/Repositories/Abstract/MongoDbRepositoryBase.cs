...
{
    public abstract class MongoDbRepositoryBase<T> : IBaseRepository<T, string> where T : BaseEntity, new()
    {
        protected readonly IMongoCollection<T> Collection;
        private readonly DatabaseSettings settings;

        public MongoDbRepositoryBase(IOptions<DatabaseSettings> options)
        {
        ...
        public virtual async Task<bool> IsExistAsync(Expression<Func<T, bool>> filter)
        {
